    ...
    render() {
        return (
            <div style={{ width: "85%", margin: "0 auto" }}>
                ...
                <h4 style={this.tagStyle}>{this.state.branchData.length != 0 ? <Text>Branch Table</Text> : <Text></Text> }</h4>
                { this.state.branchData.map((tableData => <Table tablename={"branchName"} data={tableData} />))}
                <h4 style={this.tagStyle}>{this.state.domainData.length != 0 ? <Text>Domain Table</Text> : <Text></Text> }</h4>
                { this.state.domainData.map((tableData => <Table tablename={"domainName"} data={tableData} />))}
                <h4 style={this.tagStyle}>{this.state.webhookData.length != 0 ? <Text>Webhook Table</Text> : <Text></Text> }</h4>
                ...
                <h4 style={this.tagStyle}>{this.state.jobData.length != 0 ? <Text>Job Table</Text>: <Text></Text> }</h4>
